...
export default class Declaracion implements Instruccion {
    ...
    public E1: Expresion;
    public E2: Expresion;
    public E11: Expresion;
    public E22: Expresion;
    public typeArray: any;

    public constante: any;

    public Array: any;
    constructor(type: Tipo, lista_ids: Array<string>, expresion: any, linea: number, columna: number, typeArray?: Tipo, E1?: any, E2?: any, E11?: any, E22?: any, Array?: any, constante?: boolean) {
        this.type = type;
            ...
            if (this.E1 == null && this.E11 == null) {
                ...
                if (this.E2 == null && this.E22 == null) {
                    ...
                    if (this.E2 == null) {
                        ...
                        let nuevo_simbolo = new Simbolo(4, this.type, id, valores1, this.linea, this.columna);
                        ts.agregar(id, nuevo_simbolo);
                    } else {
